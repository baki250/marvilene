...
public function getChildCategories($categoryId) //inserted for random subcategories on category page
     ...
     */
	   ...
	   public function getImageUrl($category) /*for curated pages*/
      {
    ...
    protected function _renderCategoryMenuItemHtml($category, $level = 0, $isLast = false, $isFirst = false,
        $isOutermost = false, $outermostItemClass = '', $childrenWrapClass = '', $noEventAttributes = false, $rendermode) /*for curated pages*/
    {
        ...
        $htmlLi .= '>';
        $html[] = $htmlLi;
		if($rendermode == 'image' && $this->getImageUrl($category)){ /*for curated pages*/
     ...
     * @return string
     */
      public function drawItem($category, $level = 0, $last = false, $rendermode) /*for curated pages*/
      {
