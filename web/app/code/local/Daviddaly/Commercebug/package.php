<?php
	class Commercebug_Packager
	{
		...
		{
			$string = '<?xml version="1.0" encoding="UTF-8"?><config><modules><Daviddaly_Commercebug><active>true</active><codePool>local</codePool></Daviddaly_Commercebug></modules></config>';
			$string = str_replace('Daviddaly_', $this->namespace . '_',$string);
