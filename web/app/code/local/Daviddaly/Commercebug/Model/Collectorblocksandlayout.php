<?php 
	class Daviddaly_Commercebug_Model_Collectorblocksandlayout extends Daviddaly_Commercebug_Model_Observingcollector
	{
		...
		{		
			...
			foreach($this->_blocks as $block)
			{
				...
				if(strpos($class,'Daviddaly_Commercebug') === 0)
				{
					continue;
				}
