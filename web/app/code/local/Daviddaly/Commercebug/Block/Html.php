<?php
	class Daviddaly_Commercebug_Block_Html extends Mage_Core_Block_Template
	{	
		...
		{
			$paths_to_check = array(Mage::getBaseDir('design'),Mage::getModuleDir('', 'Daviddaly_Commercebug'));
			$valid			= false;
	    ...
	    {	    	
	    	$module_dir = Mage::getModuleDir('', 'Daviddaly_Commercebug');
        ...
        *   Daviddaly_Commercebug_Block_Html
        ...
        */
        ...
        protected function _tabsAscommercebugLayout()
        {
            ...
            <?php
                $data = new stdClass();
                $data->dot = Daviddaly_Commercebug_Model_Observer_Dot::renderGraph();
            ?>
