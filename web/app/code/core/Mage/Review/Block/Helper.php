...
class Mage_Review_Block_Helper extends Mage_Core_Block_Template
{
    ...
    public function getReviewsAnchor()
    {   //Added this function to link to the bottom part of the page from review summary AD
        return "#reviews";
        //return Mage::getProductUrl() . "#reviews";
        //return $_link->getProductUrl() . "#reviews";
    }
